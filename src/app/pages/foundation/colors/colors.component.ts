          ...
          <div class="color-section">
            ...
            <div class="scale-grid">
              <div class="scale-item" *ngFor="let color of blueScale">
                ...
                <div class="scale-info">
                  ...
                  <span class="scale-value">{{ getActualColorValue('--blue-' + color.shade) || color.value }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="scale-grid">
              <div class="scale-item" *ngFor="let color of redScale">
                ...
                <div class="scale-info">
                  <span class="scale-shade">{{ color.shade }}</span>
                  <span class="scale-value">{{ getActualColorValue('--red-' + color.shade) || color.value }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="scale-grid">
              <div class="scale-item" *ngFor="let color of surfaceScale">
                ...
                <div class="scale-info">
                  <span class="scale-shade">{{ color.shade }}</span>
                  <span class="scale-value">{{ getActualColorValue('--surface-' + color.shade) || color.value }}</span>
                </div>
              </div>
            </div>
          </div>
